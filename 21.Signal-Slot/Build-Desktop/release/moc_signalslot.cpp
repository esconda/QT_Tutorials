...
QT_MOC_LITERAL(1, 11, 10), // "emitsignal"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 4), // "info"
QT_MOC_LITERAL(4, 28, 8) // "slotcall"

    },
    "SignalSlot\0emitsignal\0\0info\0slotcall"
};
...
void SignalSlot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slotcall((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SignalSlot::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignalSlot::emitsignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SignalSlot::emitsignal(QString _t1)
{
